...
public enum HDFSOperationType implements OperationType {
  ...
  S3METADATA_GET_PATH,
  S3METADATA_PUT_PATH,
  S3METADATA_DELETE_PATH,
  S3METADATA_PUT_PATHS,
  S3METADATA_DELETE_PATHS,
  S3METADATA_IS_DIR_EMPTY,
  S3METADATA_DELETE_BUCKET,
  S3METADATA_GET_EXPIRED_FILES,
  S3METADATA_GET_PATH_CHILDREN;
}
