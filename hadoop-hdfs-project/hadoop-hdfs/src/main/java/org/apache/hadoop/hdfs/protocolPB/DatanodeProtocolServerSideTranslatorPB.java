...
public class DatanodeProtocolServerSideTranslatorPB
  ...
  @Override
  public DatanodeProtocolProtos.GetCompletedBlockMetaResponseProto getCompletedBlockMeta(RpcController controller, DatanodeProtocolProtos.GetCompletedBlockMetaRequestProto request) throws ServiceException {
    try {
      DatanodeProtocolProtos.GetCompletedBlockMetaResponseProto.Builder rspBuilder = DatanodeProtocolProtos.GetCompletedBlockMetaResponseProto.newBuilder();
      Block blockmeta = impl.getCompletedBlockMeta(request.getBlockId());
      if (blockmeta != null) {
        rspBuilder.setBlock(PBHelper.convert(blockmeta));
      }
