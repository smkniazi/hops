...
public class DatanodeProtocolClientSideTranslatorPB
  ...
  public Block getCompletedBlockMeta (long blockId) throws IOException {
    DatanodeProtocolProtos.GetCompletedBlockMetaRequestProto.Builder request = DatanodeProtocolProtos.GetCompletedBlockMetaRequestProto.newBuilder();
    request.setBlockId(blockId);
    try {
      DatanodeProtocolProtos.GetCompletedBlockMetaResponseProto response = rpcProxy.getCompletedBlockMeta(NULL_CONTROLLER, request.build());
