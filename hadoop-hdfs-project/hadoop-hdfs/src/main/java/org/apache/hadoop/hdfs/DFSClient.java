...
public class DFSClient implements java.io.Closeable, RemotePeerFactory,
  ...
  public static class Conf {
    ...
    public Conf(Configuration conf) {
      ...
      completeFileTimeout = conf.getInt(
              DFS_CLIENT_COMPLETE_FILE_TIMEOUT,
              DFS_CLIENT_COMPLETE_FILE_TIMEOUT_DEFAULT);
  ...
  int getCompleteFileTimeout() {
    return dfsClientConf.completeFileTimeout;
  }
