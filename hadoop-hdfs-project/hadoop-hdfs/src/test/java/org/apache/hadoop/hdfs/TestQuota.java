...
public class TestQuota {
  ...
  public void testSpaceCommands() throws Exception {
    ...
    try {
      ...
      c = dfs.getContentSummary(quotaDir1);
      assertEquals(c.getSpaceQuota(), 4 * fileSpace);
      LOG.debug("XXX quotaDir1 "+quotaDir1.getName()+" ds: "+c.getSpaceQuota()+" dsq: "+c.getSpaceConsumed());
      // verify space before append;
      c = dfs.getContentSummary(dstPath);
      LOG.debug("XXX dstPath "+quotaDir1.getName()+" ns: "+c.getSpaceQuota()+" nsq: "+c.getSpaceConsumed()+" expected: "+3*fileSpace);
      assertEquals(c.getSpaceConsumed(), 3 * fileSpace);
      Thread.sleep(10000);
